...
Para la clase "Catalogo" como sus invariantes "" , "año_publicacion" (que no puede tener fechas imposibles o del futuro) y "empresa_desarrolladora" (no puede estar vacias, aunque la opcion "indie" terminaria aglomerando a la mayoria de empresas menores o que realizaron solo un juegos para que sean derivados a una sublista y así darle cierta prioridad a las empresas de mayor rendimiento economico a la plataforma).
